...
struct key_tab init_keytab[] = {
        ...
        {FUNC_KMAP, SPEC | 75, {backchar}               },
        {FUNC_KMAP, SPEC | 77, {forwchar}               },
        ...
        {FUNC_KMAP, SPEC | 'C', {forwchar}              },
        {FUNC_KMAP, SPEC | 'D', {backchar}              },
